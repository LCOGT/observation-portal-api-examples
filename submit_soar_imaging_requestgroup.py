#!/bin/env python
"""
submit_soar_imaging_requestgroup.py

Submit an imaging RequestGroup to be scheduled for observing on the SOAR telescope.
"""
import requests
...
# are required fields in a configuration that are ultimately filled in with defaults when possible
...
requestgroup = {
    'name': 'Example Request 4',  # The title
