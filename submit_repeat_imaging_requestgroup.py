#!/bin/env python
"""
submit_repeat_imaging_requestgroup.py

Submit an imaging RequestGroup with a repeated set of exposures to be scheduled for observing.
"""
import requests
...
configurations = [
    {
        ...
        'acquisition_config': {},
        'guiding_config': {},
        # The instrument configs will be looped repeatedly for 1500 seconds
        'repeat_duration': 1500,
        'instrument_configs': [
            {
                'exposure_time': 30,
                'exposure_count': 1,
...
requestgroup = {
    'name': 'Repeat Exposure Example',  # The title
